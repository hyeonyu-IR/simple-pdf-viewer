...
REFINED_ICON_IMAGE_SOURCE_PATH="${ROOT_DIR}/assets/AppIcon-source.png"
...
if [[ -z "${ICON_SOURCE_PATH}" ]]; then
  ...
  elif [[ -f "${REFINED_ICON_IMAGE_SOURCE_PATH}" ]]; then
    ICON_SOURCE_PATH="${REFINED_ICON_IMAGE_SOURCE_PATH}"
